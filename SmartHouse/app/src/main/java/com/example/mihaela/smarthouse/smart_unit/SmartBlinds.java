 ...
 */
public class SmartBlinds extends   ASmartUnit{
    private final Context context;

    public SmartBlinds(String id, String name,Context context){
        super(id, name);
    ...
    public void updateServerData(Boolean status){
        ...
        try {
            obj.put("stare",st);
            String url=this.urlstub+"c_jaluzele/"+this.getId();
    ...
    public void initialise() {
        String url = ASmartUnit.urlstub+"c_jaluzele/" + this.getId();
