 ...
 */
public class SmartGarageDoor extends ASmartUnit {
    private final Context context;
    public SmartGarageDoor(String id, String name,Context context){
        super(id,name);
    ...
    public void updateServerData(Boolean status) {
        ...
        this.setStatus(status);
        String url ="http://52.38.78.32:8080/api/sensors/yard/default/set/garagedooropen/";
    ...
    public void setServerGarageDoor(Boolean status){
        String url ="http://52.38.78.32:8080/api/sensors/yard/default/set/garagedooropen";
        String stat=status?"true":"false";
        url+=stat;
    }
    ...
    public void parseServerData(JSONObject responseObject) {
        try {
            String status=responseObject.getString("garagedooropen");
